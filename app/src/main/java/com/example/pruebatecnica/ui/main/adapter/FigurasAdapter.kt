package com.example.pruebatecnica.ui.main.adapter
...
import com.example.pruebatecnica.databinding.ItemFiguraBinding

class FigurasAdapter : RecyclerView.Adapter<FigurasAdapter.FiguraViewHolder>() {
    var figuras: List<FiguraEntity> = emptyList()
    ...
    fun actualizarFiguras(figuras: List<FiguraEntity>) {
